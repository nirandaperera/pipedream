...
class Stage2(torch.nn.Module):
    def __init__(self):
        ...
        self.layer61 = torch.nn.Conv2d(1024, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layer64 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        self.layer65 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer66 = torch.nn.ReLU(inplace=True=True)
        self.layer67 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layer68 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer69 = torch.nn.Conv2d(1024, 2048, kernel_size=(1, 1), stride=(2, 2), bias=False)
        ...
        self.layer73 = torch.nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layer76 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
        ...
        self.layer79 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layer80 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer82 = torch.nn.ReLU(inplace=True=True)
        self.layer83 = torch.nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layer86 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
        self.layer87 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer88 = torch.nn.ReLU(inplace=True=True)
        self.layer89 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layer90 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer92 = torch.nn.ReLU(inplace=True=True)
        self.layer93 = torch.nn.AvgPool2d(kernel_size=7, stride=1, padding=0)
        self.layer96 = torch.nn.Linear(in_features=2048, out_features=1000, bias=True)
    ...
    def forward(self, input1):
        ...
        out69 = self.layer69(out60)
        out70 = self.layer70(out69)
        out68 = out68 + out70
        out72 = self.layer72(out68)
