...
class Stage3(torch.nn.Module):
    def __init__(self):
        ...
        self.layer11 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.layer12 = torch.nn.ReLU(inplace=True=True)
        self.layer13 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.layer14 = torch.nn.ReLU(inplace=True=True)
        self.layer15 = torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.layer18 = torch.nn.Linear(in_features=25088, out_features=4096, bias=True)
        self.layer19 = torch.nn.ReLU(inplace=True=True)
        self.layer20 = torch.nn.Dropout(p=0.5, inplace=True=False)
        self.layer21 = torch.nn.Linear(in_features=4096, out_features=4096, bias=True)
        self.layer22 = torch.nn.ReLU(inplace=True=True)
        self.layer23 = torch.nn.Dropout(p=0.5, inplace=True=False)
        self.layer24 = torch.nn.Linear(in_features=4096, out_features=1000, bias=True)
