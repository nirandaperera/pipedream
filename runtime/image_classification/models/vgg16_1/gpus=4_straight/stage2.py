...
class Stage2(torch.nn.Module):
    def __init__(self):
        ...
        self.layer7 = torch.nn.Conv2d(256, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.layer13 = torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
